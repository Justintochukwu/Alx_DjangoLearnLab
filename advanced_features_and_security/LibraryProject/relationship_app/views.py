...
# Role-based views
def is_admin(user):
    return hasattr(user, 'userprofile') and user.role == 'Admin'
...
def is_librarian(user):
    return hasattr(user, 'userprofile') and user.role == 'Librarian'
...
def is_member(user):
    return hasattr(user, 'userprofile') and user.role == 'Member'
